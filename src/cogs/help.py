...
class Help(commands.Cog):
    ...
    async def help(self, ctx):
        ...
        embed.add_field(
            ...
            value='Gives you a prediction to a question.',
            inline=False
        )
        embed.add_field(
            name='vibe',
            value='Reads a user\'s vibe. If no user is tagged, reads the author\'s vibe.',
            inline=False
        )
        embed.add_field(
            name='whois',
            value='Displays the specified user\'s info. If no user is tagged, displays the author\'s info.'
        )
        embed.add_field(
            name='pfp',
            value='Displays the specified user\'s profile picture.'
        )
        embed.add_field(
            name='server / serverstats / stats / info',
            value='Displays server info.',
            inline=False
        )
        embed.add_field(
            name='links / membership-dues / feedback / fees / ops',
            value='Displays various important KnightHacks links'
        )
        embed.add_field(
            name='weather',
            value='Displays specified city\'s current weather.',
            inline=False
        )
        ...
        embed.add_field(name='github / gh',
                        value='Modibot Source Code', inline=False)
        embed.add_field(
            name='tutorial',
            value='Video tutorial on how to write a discord bot in python.',
            inline=False
        )
